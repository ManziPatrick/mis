        ...
        <div className='flex flex-col gap-[20px] bg-[#2E3487] w-full min-h-[100vh] justify-between pb-4'>
            <div className='flex flex-col gap-[10px]'>
                ...
                <div className='flex flex-col gap-[20px] px-4'>
                    <Link href='/hr' className={`${pathname == "/hr" ? "p-4 rounded-[12px] bg-white text-black" : " text-white px-4"} flex flex-row items-center gap-[10px] `}>
                        <MdDashboardCustomize size={18} />
                        <span className='text-[14px] font-[400]'>Dashbaord</span>
                    </Link>
                </div>
                <div className='flex flex-col gap-[20px] px-4'>
                    <Link href='/hr/employees' className={`${pathname == "/hr/employees" ? "p-4 rounded-[12px] bg-white text-black" : " text-white px-4"} flex flex-row items-center gap-[10px] `}>
                        <FaUsers size={18} />
                        <span className='text-[14px] font-[400]'>Employees</span>
                    </Link>
                </div>
                <div className='flex flex-col gap-[20px] px-4'>
                    <Link href='/hr/payroll' className={`${pathname == "/hr/payroll" ? "p-4 rounded-[12px] bg-white text-black" : " text-white px-4"} flex flex-row items-center gap-[10px] `}>
                        <PiContactlessPaymentBold size={18} />
                        <span className='text-[14px] font-[400]'>Payroll</span>
                    </Link>
                </div>
            </div>
            ...
            <div className='flex flex-col gap-[10px] px-5'>
                ...
                <Link href={`/admin`} className='flex flex-row items-center font-[600] text-[14px] gap-[10px] bg-white rounded-[6px]  p-3 cursor-pointer'>
                    <TbSwitchHorizontal size={20} />  Back Admin
                </Link>
