...
import ProcurementSidebar from "@/components/sidebar/ProcurementSidebar";
...
export default function RootLayout({
    ...
    useEffect(() => {
        ...
        else if (status == "authenticated" && (session.user.role == "procurement" || session.user.role == "admin")) {
            setIsLoading(false)
            setIsAllowed(true)
        }else{
            setIsNotAuth(true)
