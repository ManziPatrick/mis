        ...
        <div className="flex flex-col gap-[20px] p-4">
            ...
            {isLoading ? (
                ...
                <>
                    ...
                    {isError && (
                        <div className="w-full p-10 rounded-[6px] bg-white flex items-center justify-center">            <div className="w-full flex  items-center text-center justify-center p-2 flex-col gap-[3px]">
